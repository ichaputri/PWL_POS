...
class BarangController extends Controller
{
    ...
    {
        $barangs = BarangModel::select('barang_id', 'barang_kode', 'kategori_id', 'barang_nama', 'harga_beli', 'harga_jual', 'image')->with('kategori');
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'image' => 'required|file|image|max:5000' // Validate image file
        ]);
    ...
    public function update(Request $request, string $id)
    {
        $request->validate([
            ...
            'harga_beli' => 'required|numeric|min:0',
            'harga_jual' => 'required|numeric|min:0',
            'image' => 'nullable|file|image|max:5000' // Validate image file
        ]);
